...
public class SuperHeroDisplay : NetworkBehaviour
{
    public Location superHero;
    public bool inRuins;
    ...
    public void setLocation(Location SH){
        superHero = SH;
        inRuins = superHero.inRuins;
        gameObject.tag = superHero.cardTag;
        nameText.text = superHero.cardName;
        attackInt = superHero.cardAttack;
        health2Int = superHero.cardHealth2;
        healthRemaining = health2Int;
        abilityText.text = superHero.cardAbility;
    ...
    public void changeLandscape(){
            string destination3 = "Card Images/Artwork/Creepy Mines";
            transform.GetChild(1).GetChild(0).GetComponent<Image>().sprite = Resources.Load(destination3, typeof(Sprite)) as Sprite;
    }

    public void changeBackground(){
        if(inRuins){
            string destination4 = "Card Images/Outline SuperHeroRuins";
            transform.GetChild(1).GetChild(1).GetComponent<Image>().sprite = Resources.Load(destination4, typeof(Sprite)) as Sprite;
        }
    }
